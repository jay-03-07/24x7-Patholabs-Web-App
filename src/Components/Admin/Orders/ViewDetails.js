    ...
    useEffect(() => {
        ...
        onValue(ordersRef, (snapshot) => {
            ...
            if (ordersData) {
                ...
                for (const phoneNumber in ordersData) {
                    if (ordersData[phoneNumber][orderId]) {
                        setOrder({ id: orderId, phoneNumber, ...ordersData[phoneNumber][orderId] });
                        break;
                    }
                }
            } else {
                    ...
                    <Row>
                        <Col>
                            <Card className="mb-4 shadow-lg border-0" style={{ backgroundColor: 'white' }}>
                                <Card.Header className="text-white text-center" style={{ backgroundColor: '#263043' }}>
                                ...
                                <Card.Body>
                                    ...
                                    <Row>
                                        ...
                                        <Col md={6}>
                                            <strong>Report:</strong> {order.report === 'Generated' ? (
                                                <Button variant="success" href={order.reportUrl} target="_blank" rel="noopener noreferrer">Download Report</Button>
                                            ) : (
                        ...
                        <Col md={4}>
                            <Row>
                                <Col md={12} className='shadow'>
                                    ...
                                    <Button variant="secondary" className='w-100 mb-4' onClick={() => window.history.back()}>Back to Orders</Button>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                                    ...
                                    {order.cartItems.map((item, index) => (
                                        <div key={index} className="mb-4 border-bottom pb-3">
                                            ...
                                            <Card.Text style={{ fontWeight: '500' }}>
                                                ...
                                                <Button variant="link" style={{ marginTop: '-5px', textDecoration: 'none', color: 'blue', fontWeight: 'bold' }} onClick={() => handleViewPackage(item)}>View All</Button>
                                            </Card.Text>
                                            <Card.Text style={{ fontWeight: '500' }}>
