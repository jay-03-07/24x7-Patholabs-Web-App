    ...
    return (
        <Modal show={showModal} onHide={handleCloseModal} size="lg" fullscreen={fullscreen} >
            <Modal.Header closeButton>
                <Modal.Title style={{fontWeight: 'bold'}}>Package Details</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {selectedPackage && (
                                    ...
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <Card.Text style={{ fontWeight: '500' }}>
                                                ...
                                                <Button variant="link" style={{ marginTop: '-5px', textDecoration: 'none', color: 'blue', fontWeight: '500' }} onClick={scrollToTestDetails}>View All</Button>
                                            </Card.Text>
                                            <Card.Text style={{ fontWeight: '500' }}>
